        ...
        # 如果是运算符
            ...
            while True:
                ...
                # 如果是0，则弹出运算符栈内最后一个'('并丢掉当前')'，进入下一次循环
                    ...
                    op_stack.pop()
                    advanced(op_stack, num_stack)  # '('前是'√'、'sin'或'arcsin'时，对括号内算式的计算结果作相应的运算
                    break
...
if __name__ == '__main__':
    formula = input("please input you need computer:")
    formula_list = formulaFormat(formula)
    result = finalCalc(formula_list)
    print("算式：", formula)
    print("计算结果：", result)
